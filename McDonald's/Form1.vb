Public Class Form1
    ...
    Private Sub Burger_CheckBox_CheckedChanged(sender As Object, e As EventArgs) Handles Burger_CheckBox.CheckedChanged
    ...
    Private Sub Fries_CheckBox3_CheckedChanged(sender As Object, e As EventArgs) Handles Fries_CheckBox3.CheckedChanged
    ...
    Private Sub Button_Make_Bill_Click(sender As Object, e As EventArgs) Handles Button_Make_Bill.Click
